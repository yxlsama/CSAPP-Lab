/*
 * In this file, I give an malloc package using seg free list. 
 ...
 * a "prev" pointer is saved at bp, and a "next" pointer is saved at bp+1.
 * Blocks with different size is saved in different lists,
 * which is called the seg free list.  
 */
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
...
team_t team = {
    ...
    "pengsl20@mails.tsinghua.edu.cn",
...
/*
 * mm_realloc - A demo of realloc func.
 */
